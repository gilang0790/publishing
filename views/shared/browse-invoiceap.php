...
?>
<div class="invoiceap-index">
    <?=
    GridView::widget([
        'dataProvider' => $dataProvider,
        'panel' => [
            'heading' => Menuaccess::gridBrowseInvoiceapTitle(),
        ],
        'toolbar' => [
            [
                'content' =>
        ...
        'columns' => [
            ...
            [
                'attribute' => 'goodsreceiptid',
                'value' => 'goodsreceipt.grtransnum',
                'width' => '15%',
                'headerOptions' => [
                    'class' => 'text-center'
                ],
