...
/**
 * SupplierSearchModel represents the model behind the search form of `app\modules\common\models\Supplier`.
 */
class SupplierSearchModel extends Supplier
{
    /**
     * @inheritdoc
     */
    ...
    public static function findActive() {
        return self::find()
            ->andWhere(self::tableName() . '.isvendor = true')
