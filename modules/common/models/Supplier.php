 ...
 *
 * @property MsCity $city
 * @property MsProduct[] $msProducts
 */
class Supplier extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['iscustomer', 'isemployee', 'isvendor', 'ishospital', 'cityid', 'discount', 'status'], 'integer'],
            ...
            [['iscustomer', 'isemployee', 'isvendor', 'ishospital'], 'default', 'value' => 0],
