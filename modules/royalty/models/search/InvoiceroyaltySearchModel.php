...
/**
 * InvoiceroyaltySearchModel represents the model behind the search form of `app\modules\royalty\models\Invoiceroyalty`.
 */
class InvoiceroyaltySearchModel extends Invoiceroyalty
{
    public $dateFrom;
    public $dateTo;
    /**
        ...
        $dataProvider = new ActiveDataProvider([
            ...
            'sort' => [
                ...
                'attributes' => [
                    ...
                    ], 'transdate', 'transnum', 'amount', 'payamount'
                ]
            ],
            'pagination' => [
                'pageSize' => 15,
