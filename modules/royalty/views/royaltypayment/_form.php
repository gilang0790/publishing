            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <?= $form->field($model, 'rptransdate')->widget(DateControl::className()) ?>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <?= $form->field($model, 'invoiceamount')->textInput(['class' => 'form-control input-decimal text-right', 'readonly' => true]) ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <?= $form->field($model, 'paidamount')->textInput(['class' => 'form-control input-decimal text-right', 'readonly' => true]) ?>
                        </div>
                        <div class="col-md-4">
                            <?= $form->field($model, 'advanceamount')->textInput(['class' => 'form-control input-decimal text-right', 'readonly' => true]) ?>
                        </div>
                        <div class="col-md-4">
...
$(document).ready(function () {
    ...
    $('.box-footer').on('click', '.btnSave', function (e) {
        ...
        var strAramount = $('#royaltypaymentform-invoiceamount').val();
        var strPaidamount = $('#royaltypaymentform-paidamount').val();
        var strAdvanceamount = $('#royaltypaymentform-advanceamount').val();
        var strPayamount = $('#royaltypaymentform-stringpayamount').val();
        var invoiceamount = strAramount.split('.').join("");
        ...
        var sisa = parseInt(invoiceamount) - parseInt(paidamount);
