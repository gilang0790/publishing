            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <?= $form->field($model, 'umrtransdate')->widget(DateControl::className()) ?>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <?= $form->field($model, 'stringAmount')->textInput(['class' => 'form-control input-decimal text-right']) ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
