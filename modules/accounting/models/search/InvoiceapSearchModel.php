...
class InvoiceapSearchModel extends Invoiceap
{
    public $dateFrom;
    public $dateTo;
    /**
    ...
    public function search($params)
    {
        ...
        if (Wfgroup::getStatusList('listap')) {
            $statusList = Wfgroup::getStatusList('listap');
        }
        $query->andWhere("ms_company.companyid IN $listCompany");
        $query->andWhere("ms_plant.plantid IN $listPlant");
        $query->andWhere("tr_invoiceap.status IN $statusList");
