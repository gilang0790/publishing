...
class InvoicearSearchModel extends Invoicear
{
    public $dateFrom;
    public $dateTo;
    /**
    ...
    public function search($params)
    {
        ...
        if (Wfgroup::getStatusList('listar')) {
            $statusList = Wfgroup::getStatusList('listar');
        }
        $query->andWhere("ms_company.companyid IN $listCompany");
        $query->andWhere("ms_plant.plantid IN $listPlant");
        $query->andWhere("tr_invoicear.status IN $statusList");
