...
<html lang="id">
    ...
    <body>
        ...
        <div style="font-size: 12px">
            <div style="margin-top: 10px; text-align: center; font-size: 16px;"><b>Pembayaran Pembelian</b></div>
            <div style="margin-top: 20px;">
                ...
                <div style="float: left;">
                    <div style="display: block; margin-left: 50px;">
                        <table style="width: 100%; font-size: 12px;">
                            <tr>
                                <td style="width: 150px; font-weight: bold;"><?= $model->getAttributeLabel('pptransnum') ?></td>
                                <td style="width: 15px;">:</td>
                                <td><?= $model->pptransnum ?></td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;"><?= $model->getAttributeLabel('pptransdate') ?></td>
                                <td>:</td>
                                <td><?= date_format(date_create($model->pptransdate), 'd/M/Y') ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
            ...
            <div style="margin-top: 30px;">
                <div style="display: block;">
                    <table style="width: 100%; margin-left: -3px; font-size: 12px; border-collapse: collapse;">
                        <thead>
                            <tr>
                                <th style="width: 15%; padding-bottom: 5px; text-align: center; border-bottom:1px solid #000"><?= $model->getAttributeLabel('invoiceapid') ?></th>
                                <th style="width: 15%; padding-bottom: 5px; text-align: center; border-bottom:1px solid #000"><?= $model->getAttributeLabel('apamount') ?></th>
                        ...
                        <tbody>
                            <tr style="margin: 5px 1%; ">
                                <td style="padding-top: 6px; padding-bottom: 6px; border-bottom:1px solid #000;"><?= $model->invoiceap->aptransnum ?>&nbsp;</td>
                                <td style="text-align: right; padding-top: 6px; padding-bottom: 6px; border-bottom:1px solid #000; "><?= number_format($model->apamount, 2, ",", ".") ?></td>
