...
<html lang="id">
    ...
    <body>
        ...
        <div style="font-size: 12px">
            <div style="margin-top: 10px; text-align: center; font-size: 16px;"><b>Faktur Pembelian</b></div>
            <div style="margin-top: 20px;">
                <div style="float: left; width: 50%;">
                    <div style="display: block; margin-left: -3px;">
                        <table style="width: 100%; font-size: 12px;">
                            ...
                            <tr>
                                <td style="font-weight: bold;"><?= $model->getAttributeLabel('goodsreceiptid') ?></td>
                                <td>:</td>
                                <td><?= $model->goodsreceipt->grtransnum ?></td>
                            </tr>
                            <tr>
                ...
                <div style="float: left;">
                    <div style="display: block; margin-left: 50px;">
                        <table style="width: 100%; font-size: 12px;">
                            <tr>
                                <td style="width: 150px; font-weight: bold;"><?= $model->getAttributeLabel('aptransnum') ?></td>
                                <td style="width: 15px;">:</td>
                                <td><?= $model->aptransnum ?></td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;"><?= $model->getAttributeLabel('aptransdate') ?></td>
                                <td>:</td>
                                <td><?= date_format(date_create($model->aptransdate), 'd/M/Y') ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
                    ...
                    <table style="width: 100%; margin-left: -3px; font-size: 12px; border-collapse: collapse;">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td colspan="2" style="text-align:right; border-top: 1px solid #000;"><strong><?= number_format($model->apamount, 2, ",", ".") ?></strong></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
