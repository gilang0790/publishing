...
<html lang="id">
    ...
    <body>
        ...
        <div style="font-size: 12px">
            <div style="margin-top: 10px; text-align: center; font-size: 16px;"><b>Penerimaan Penjualan</b></div>
            <div style="margin-top: 20px;">
                ...
                <div style="float: left;">
                    <div style="display: block; margin-left: 50px;">
                        <table style="width: 100%; font-size: 12px;">
                            <tr>
                                <td style="width: 150px; font-weight: bold;"><?= $model->getAttributeLabel('sptransnum') ?></td>
                                <td style="width: 15px;">:</td>
                                <td><?= $model->sptransnum ?></td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;"><?= $model->getAttributeLabel('sptransdate') ?></td>
                                <td>:</td>
                                <td><?= date_format(date_create($model->sptransdate), 'd/M/Y') ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
            ...
            <div style="margin-top: 30px;">
                <div style="display: block;">
                    <table style="width: 100%; margin-left: -3px; font-size: 12px; border-collapse: collapse;">
                        <thead>
                            <tr>
                                <th style="width: 15%; padding-bottom: 5px; text-align: center; border-bottom:1px solid #000"><?= $model->getAttributeLabel('invoicearid') ?></th>
                                <th style="width: 15%; padding-bottom: 5px; text-align: center; border-bottom:1px solid #000"><?= $model->getAttributeLabel('aramount') ?></th>
                                <th style="width: 10%; padding-bottom: 5px; text-align: center; border-bottom:1px solid #000"><?= $model->getAttributeLabel('paidamount') ?></th>
                                <th style="width: 10%; padding-bottom: 5px; text-align: center; border-bottom:1px solid #000"><?= $model->getAttributeLabel('advanceamount') ?></th>
                                <th style="width: 10%; padding-bottom: 5px; text-align: center; border-bottom:1px solid #000"><?= $model->getAttributeLabel('payamount') ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr style="margin: 5px 1%; ">
                                <td style="padding-top: 6px; padding-bottom: 6px; border-bottom:1px solid #000;"><?= $model->invoicear->artransnum ?>&nbsp;</td>
                                <td style="text-align: right; padding-top: 6px; padding-bottom: 6px; border-bottom:1px solid #000; "><?= number_format($model->aramount, 2, ",", ".") ?></td>
                                <td style="text-align: right; padding-top: 6px; padding-bottom: 6px; border-bottom:1px solid #000; "><?= number_format($model->paidamount, 2, ",", ".") ?></td>
                                <td style="text-align: right; padding-top: 6px; padding-bottom: 6px; border-bottom:1px solid #000; "><?= number_format($model->advanceamount, 2, ",", ".") ?></td>
                                <td style="text-align: right; padding-top: 6px; padding-bottom: 6px; border-bottom:1px solid #000; "><?= number_format($model->payamount, 2, ",", ".") ?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
