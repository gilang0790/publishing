...
<html lang="id">
    ...
    <body>
        ...
        <div style="font-size: 12px">
            <div style="margin-top: 10px; text-align: center; font-size: 16px;"><b>Pesanan Pembelian</b></div>
            <div style="margin-top: 20px;">
                <div style="float: left; width: 50%;">
                    <div style="display: block; margin-left: -3px;">
                        <table style="width: 100%; font-size: 12px;">
                            <tr>
                                <td style="width: 100px; font-weight: bold;"><?= $model->getAttributeLabel('paymentmethodid') ?></td>
                                <td style="width: 15px;">:</td>
                                <td><?= $model->paymentmethod->paymentname ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="font-weight: bold;"><?= $model->getAttributeLabel('billto') ?></td>
                                <td>:</td>
                                <td><?= $model->billto ?></td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;"><?= $model->getAttributeLabel('shipto') ?></td>
                                <td>:</td>
                                <td><?= $model->shipto ?></td>
                            </tr>
                        </table>
                ...
                <div style="float: left;">
                    <div style="display: block; margin-left: 50px;">
                        <table style="width: 100%; font-size: 12px;">
                            <tr>
                                <td style="width: 150px; font-weight: bold;"><?= $model->getAttributeLabel('potransnum') ?></td>
                                <td style="width: 15px;">:</td>
                                <td><?= $model->potransnum ?></td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;"><?= $model->getAttributeLabel('potransdate') ?></td>
                                <td>:</td>
                                <td><?= date_format(date_create($model->potransdate), 'd/M/Y') ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
                    ...
                    <table style="width: 100%; margin-left: -3px; font-size: 12px; border-collapse: collapse;">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 40%; padding-bottom: 5px; text-align: center; border-bottom:1px solid #000">Barang</th>
                                ...
                                <th style="width: 15%; padding-bottom: 5px; text-align: center; border-bottom:1px solid #000">Harga</th>
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="4" style="text-align:right; border-top: 1px solid #000;"><strong>Grand Total</strong></td>
