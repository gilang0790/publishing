...
<html lang="id">
    ...
    <body>
        ...
        <div style="font-size: 12px">
            <div style="margin-top: 10px; text-align: center; font-size: 16px;"><b>Pesanan Penjualan</b></div>
            <div style="margin-top: 20px;">
                <div style="float: left; width: 50%;">
                    <div style="display: block; margin-left: -3px;">
                        <table style="width: 100%; font-size: 12px;">
                            <tr>
                                <td style="width: 100px; font-weight: bold;"><?= $model->getAttributeLabel('plantid') ?></td>
                                <td style="width: 15px;">:</td>
                                <td><?= $model->plant->description ?></td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;"><?= $model->getAttributeLabel('salestype') ?></td>
                                <td>:</td>
                                <td><?= $salesType[$model->salestype] ?></td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;"><?= $model->getAttributeLabel('paymentmethodid') ?></td>
                                <td>:</td>
                                <td><?= $model->paymentmethod->paymentname ?></td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;"><?= $model->getAttributeLabel('dueDate') ?></td>
                                <td>:</td>
                                <td><?= date_format(date_create($model->dueDate), 'd/M/Y') ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="font-weight: bold;"><?= $model->getAttributeLabel('address') ?></td>
                                <td>:</td>
                                <td><?= $model->address ?></td>
                            </tr>
                        </table>
                ...
                <div style="float: left;">
                    <div style="display: block; margin-left: 50px;">
                        <table style="width: 100%; font-size: 12px;">
                            <tr>
                                <td style="width: 150px; font-weight: bold;"><?= $model->getAttributeLabel('sotransnum') ?></td>
                                <td style="width: 15px;">:</td>
                                <td><?= $model->sotransnum ?></td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;"><?= $model->getAttributeLabel('sotransdate') ?></td>
                                <td>:</td>
                                <td><?= date_format(date_create($model->sotransdate), 'd/M/Y') ?></td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;"><?= $model->getAttributeLabel('pocustomer') ?></td>
                                <td>:</td>
                                <td><?= $model->pocustomer ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
