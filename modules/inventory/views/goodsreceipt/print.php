...
<html lang="id">
    ...
    <body>
        ...
        <div style="font-size: 12px">
            <div style="margin-top: 10px; text-align: center; font-size: 16px;"><b>Penerimaan Barang</b></div>
            <div style="margin-top: 20px;">
                ...
                <div style="float: left;">
                    <div style="display: block; margin-left: 50px;">
                        <table style="width: 100%; font-size: 12px;">
                            <tr>
                                <td style="width: 150px; font-weight: bold;"><?= $model->getAttributeLabel('grtransnum') ?></td>
                                <td style="width: 15px;">:</td>
                                <td><?= $model->grtransnum ?></td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;"><?= $model->getAttributeLabel('grtransdate') ?></td>
                                <td>:</td>
                                <td><?= date_format(date_create($model->grtransdate), 'd/M/Y') ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
                    ...
                    <table style="width: 100%; margin-left: -3px; font-size: 12px; border-collapse: collapse;">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 10%; padding-bottom: 5px; text-align: right; border-bottom:1px solid #000">Jumlah Gratis</th>
                        ...
                        <tbody>
                            ...
                            <tr style="margin: 5px 1%; ">
                                ...
                                <td style="text-align: right; padding-top: 6px; padding-bottom: 6px; border-bottom:1px solid #000; "><?= number_format($detail->freeqty, 2, ",", ".") ?></td>
