...
<html lang="id">
    ...
    <body>
        ...
        <div style="font-size: 12px">
            <div style="margin-top: 10px; text-align: center; font-size: 16px;"><b>Retur Pembelian</b></div>
            <div style="margin-top: 20px;">
                ...
                <div style="float: left;">
                    <div style="display: block; margin-left: 50px;">
                        <table style="width: 100%; font-size: 12px;">
                            <tr>
                                <td style="width: 150px; font-weight: bold;"><?= $model->getAttributeLabel('grrtransnum') ?></td>
                                <td style="width: 15px;">:</td>
                                <td><?= $model->grrtransnum ?></td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;"><?= $model->getAttributeLabel('grrtransdate') ?></td>
                                <td>:</td>
                                <td><?= date_format(date_create($model->grrtransdate), 'd/M/Y') ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
