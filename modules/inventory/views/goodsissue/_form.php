                    ...
                    <div class="container-items">
                        ...
                        <div class="item row">
                            ...
                            <div class="col-sm-4 col-md-2">
                                <?= $form->field($detail, "[{$i}]qty")->textInput(['type' => 'number', 'min' => 1, 'class' => 'form-control text-right gidetailqty']) ?>
                            </div>
...
$(document).ready(function () {
    ...
    $(document).on('change', '#goodsissueform-slocid', function() {
        getStoragebin();
    });
    
    function getStoragebin() {
        var slocid = $('#goodsissueform-slocid').val();
        var i = 0;
        $('.detailProductID').each(function(){
            var productID = 'goodsissuedetail-'+i+'-productid';
            var qtyID = 'goodsissuedetail-'+i+'-qty';
            var storagebinID = 'goodsissuedetail-'+i+'-storagebinid';
    ...
    $('.box-footer').on('click', '.btnSave', function (e) {
        ...
        if (!$('#goodsissueform-gitransdate-disp').val()) {
            dateEmptyCounter += 1;
            $('.field-goodsissueform-gitransdate').addClass('has-error')
            alert('Tanggal Transaksi harus diisi!');
            return false;
        }
    
        if (!$('#goodsissueform-slocid').val()) {
            slocEmptyCounter += 1;
            $('.field-goodsissueform-slocid').addClass('has-error')
        ...
        var productID = '';
        $('.detailProductID').each(function(){
            var detailProductID = 'goodsissuedetail-'+i+'-productid';
            var detailQtyID = 'goodsissuedetail-'+i+'-qty';
            var detailStoragebinID = 'goodsissuedetail-'+i+'-storagebinid';
            var detailHppID = 'goodsissuedetail-'+i+'-hpp';
