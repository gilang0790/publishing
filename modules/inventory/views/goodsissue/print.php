...
<html lang="id">
    ...
    <body>
        ...
        <div style="font-size: 12px">
            <div style="margin-top: 10px; text-align: center; font-size: 16px;"><b>Pengeluaran Barang</b></div>
            <div style="margin-top: 20px;">
                <div style="float: left; width: 50%;">
                    <div style="display: block; margin-left: -3px;">
                        <table style="width: 100%; font-size: 12px;">
                            ...
                            <tr>
                                <td style="font-weight: bold;"><?= $model->getAttributeLabel('shippingname') ?></td>
                                <td>:</td>
                ...
                <div style="float: left;">
                    <div style="display: block; margin-left: 50px;">
                        <table style="width: 100%; font-size: 12px;">
                            <tr>
                                <td style="width: 150px; font-weight: bold;"><?= $model->getAttributeLabel('gitransnum') ?></td>
                                <td style="width: 15px;">:</td>
                                <td><?= $model->gitransnum ?></td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;"><?= $model->getAttributeLabel('gitransdate') ?></td>
                                <td>:</td>
                                <td><?= date_format(date_create($model->gitransdate), 'd/M/Y') ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
