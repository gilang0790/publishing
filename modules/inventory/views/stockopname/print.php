...
$type = AppHelper::$typeStockOpname;
...
<html lang="id">
    ...
    <body>
        ...
        <div style="font-size: 12px">
            <div style="margin-top: 10px; text-align: center; font-size: 16px;"><b>Penyesuaian Stok</b></div>
            <div style="margin-top: 20px;">
                ...
                <div style="float: left;">
                    <div style="display: block; margin-left: 50px;">
                        <table style="width: 100%; font-size: 12px;">
                            <tr>
                                <td style="width: 150px; font-weight: bold;"><?= $model->getAttributeLabel('bstransnum') ?></td>
                                <td style="width: 15px;">:</td>
                                <td><?= $model->bstransnum ?></td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;"><?= $model->getAttributeLabel('bstransdate') ?></td>
                                <td>:</td>
                                <td><?= date_format(date_create($model->bstransdate), 'd/M/Y') ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
                    ...
                    <table style="width: 100%; margin-left: -3px; font-size: 12px; border-collapse: collapse;">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 15%; padding-bottom: 5px; text-align: center; border-bottom:1px solid #000">Tipe</th>
                                <th style="width: 10%; padding-bottom: 5px; text-align: center; border-bottom:1px solid #000">Jumlah</th>
                                <th style="width: 15%; padding-bottom: 5px; text-align: center; border-bottom:1px solid #000">HPP</th>
                                <th style="width: 10%; padding-bottom: 5px; text-align: center; border-bottom:1px solid #000">Rak</th>
                                <th style="padding-bottom: 5px; text-align: center; border-bottom:1px solid #000">Total</th>    
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            <tr style="margin: 5px 1%; ">
                                ...
                                <td style="padding-top: 6px; padding-bottom: 6px; border-bottom:1px solid #000; text-align: center"><?= $type[$detail->type] ?></td>
                                <td style="text-align: right; padding-top: 6px; padding-bottom: 6px; border-bottom:1px solid #000; "><?= number_format($detail->qty, 2, ",", ".") ?></td>
                                <td style="text-align: right; padding-top: 6px; padding-bottom: 6px; border-bottom:1px solid #000; "><?= number_format($detail->hpp, 2, ",", ".") ?></td>
                                <td style="padding-top: 6px; padding-bottom: 6px; border-bottom:1px solid #000; text-align: center"><?= $detail->storagebin->description ?></td>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td colspan="2" style="text-align:right; border-top: 1px solid #000;"><strong><?= number_format($model->total, 2, ",", ".") ?></strong></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
