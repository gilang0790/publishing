 ...
 */
class GoodsissueBrowseModel extends Goodsissue
{
    public $dateFrom;
    public $dateTo;
    /**
    ...
    public function search($params)
    {
        ...
        if (Goodsissuedetail::getOutstanding()) {
            $listOutstanding = Goodsissuedetail::getOutstanding();
        }
        ...
        $query->andWhere("tr_goodsissue.id IN $listOutstanding");
    ...
    public function searchReturn($params)
    {
        ...
        if (Goodsissuedetail::getReturn()) {
            $listInvoice = Goodsissuedetail::getReturn();
        }
        $query->andWhere("ms_company.companyid IN $listCompany");
        $query->andWhere("ms_plant.plantid IN $listPlant");
        $query->andWhere("tr_goodsissue.status = $maxStatus");
        $query->andWhere("tr_goodsissue.id IN $listInvoice");
        $query->andFilterWhere([
            'id' => $this->id,
            'tr_goodsissue.status' => $this->status,
            'createdAt' => $this->createdAt,
